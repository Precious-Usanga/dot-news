...
export class PopoverService {
  ...
  private getOverlayConfig({ origin, width, height, position, offsetX, offsetY }: PopoverConfig): OverlayConfig {
  ...
  private getOverlayPosition({ origin, position, offsetX, offsetY }: PopoverConfig): PositionStrategy {
